...
func CreateServer() *App {
	...
	r.Group(func(r chi.Router) {
		...
		r.Get("/dashboard/company/{companyID}/admin", app.DashboardCompanyGet())
		r.Get("/dashboard/company-register", app.DashboardRegisterCompanyGet())
		...
		r.Get("/dashboard/application/{applicationID}", app.DashboardApplicationDetailGet())
		r.Get("/dashboard/job", app.DashboardJobListGet())
		r.Post("/job/apply", app.ApplyJobPost())

		r.Post("/interview/create", app.ScheduleInterviewPost())
		r.Post("/interview/confirm", app.ConfirmInterviewPost())
